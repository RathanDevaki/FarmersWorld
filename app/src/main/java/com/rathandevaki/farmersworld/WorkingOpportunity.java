...
public class WorkingOpportunity extends AppCompatActivity {


    private RecyclerView recyclerView;
   opportunityAdapter adapter; // Create Object of the Adapter class
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_working_opportunity);
        fb=(FloatingActionButton)findViewById(R.id.addOpportunity);
        fb.setOnClickListener(new View.OnClickListener() {
            ...
            /*  Intent intent=new Intent(Demo.this,AddProduct.class);
                ...
                Fragment fragment = new AddOpportunity();
        ...
        mbase = FirebaseDatabase.getInstance().getReference().child("JobOpportunity");
        ...
        FirebaseRecyclerOptions<Opportunity> options
                = new FirebaseRecyclerOptions.Builder<Opportunity>()
                .setQuery(mbase,Opportunity.class)
                .build();
        // Connecting object of required Adapter class to
        // the Adapter class itself
        adapter = new opportunityAdapter(options);
